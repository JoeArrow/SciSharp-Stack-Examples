...
namespace WebApi.Services
{
    public class ImageClassificationService
    {
        ...
        private void PrepareData()
        {
            ...
            // ---------------------------------------------------------
            // Pre-process it, turning them all into doubles between 0-1
            // instead of bytes between 0-255. We do this even
            // though we receive data from the user as raw bytes (0-255),
            // neural networks work better with doubles than integers
        ...
        private void PrepareModel()
        {
            ...
            baseModel.compile(loss: keras.losses.SparseCategoricalCrossentropy(from_logits: true),
        ...
        public float[] Predict(byte[] data)
        {
            ...
            // ---------------------------------------------
            // Reshape our input data into 1x (28x28) arrays
            // (AKA one 1x28x28 tensor, AKA a 3D vector)
            ...
            // -------------------------------------------
            // Create a copy of the same model, but with a
            // Softmax layer at the end to get outputs.
