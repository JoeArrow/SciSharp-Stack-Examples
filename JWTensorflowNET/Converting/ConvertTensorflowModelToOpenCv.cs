...
namespace JWTensorflowNET.Converting
{
    // ----------------------------------------------------
    /// <summary>
    ///     ConvertTensorflowModelToOpenCv Description
    /// </summary>

    public class ConvertTensorflowModelToOpenCv : absSciSharpBase, IJWTensorBase
    {
        ...
        public override void PrepareData()
        {
            ...
            var url = "http://download.tensorflow.org/models/object_detection/ssd_mobilenet_v1_coco_2018_01_28.tar.gz";
            ...
            // -----------------------
            // download the pbtxt file (JSON file identifying images)
