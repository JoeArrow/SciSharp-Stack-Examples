...
namespace JWTensorflowNET.ObjectDetection
{
    // ----------------------------------------------------
    /// <summary>
    ///     YoloCoco Description
    /// </summary>

    public class YoloCoco : absSciSharpBase, IJWTensorBase
    {
        int input_size = 416;
        int num_classes = 1;

        string[] return_elements = new[] { "input/input_data:0", "pred_sbbox/concat_2:0", 
