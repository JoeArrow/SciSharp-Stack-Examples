...
namespace JWTensorflowNET.ImageProcessing
{
    // ----------------------------------------------------
    /// <summary>
    ///     DigitRecognitionCnnEager Description
    /// </summary>

    public class DigitRecognitionCnnEager : absSciSharpBase, IJWTensorBase
    {
        // -------------------------
        ...
        public override void Train()
        {
            ...
            // --------------------------------
            // Conv Layer 1: 5x5 conv, 1 input,
            // 32 filters (MNIST has 1 color channel only).
        ...
        Tensor conv_net(Tensor x)
        {
            ...
            // -------------------------------------------
            // Reshape conv2 output to fit fully connected
            // layer input, Output shape: [-1, 7*7*64].
            ...
            // ----------------------------------------
            // Apply softmax to normalize the logits to
