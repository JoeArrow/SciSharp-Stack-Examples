...
namespace JWTensorflowNET.TextProcessing
{
    ...
    public class Word2Vec : absSciSharpBase, IJWTensorBase
    {
        // -------------------
        // Training Parameters
        ...
        private (NDArray, NDArray) next_batch(int batch_size, int num_skips, int skip_window)
        {
            ...
            // -------------------------------
            // Backtrack a little bit to avoid
            // skipping words in the end of a batch
        ...
        public override void PrepareData(IReq req)
        {
            ...
            // --------------------------------
            // Retrieve a word id, or assign it
            // index 0 ('UNK') if not in dictionary
