...
//using JWTensorflowNET.Text;

using static Tensorflow.Binding;
using JWTensorflowNET.TextProcessing.cnn_models;
...
namespace JWTensorflowNET.TextProcessing
{
    // ----------------------------------------------------
    /// <summary>
    ///     CnnTextClassification Description
    /// </summary>

    public class CnnTextClassification : absSciSharpBase, IJWTensorBase
    {
